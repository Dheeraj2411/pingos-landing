...
const plans = [
  {
    ...
    tier: "free",
    features: [
      { text: "1 Official WhatsApp Number", included: true },
      { text: "500 WhatsApp Contacts", included: true },
      { text: "1,000 WABA Conversations", included: true },
  ...
  },
  {
    ...
    features: [
      { text: "1 Official WhatsApp Number", included: true },
      { text: "10,000 WhatsApp Contacts", included: true },
      { text: "50,000 WABA Conversations", included: true },
      ...
      { text: "WhatsApp Drip Campaigns", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Custom Conversation Volume", included: true },
